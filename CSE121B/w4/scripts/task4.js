...
myInfo.name = "Luis Flores";

// Step 3: Add another property named photo with a value of the image path and name (used in Task 2) as a string

myInfo.photo = "../w2/images/luisflores.jpg";

// Step 4: Add another property named favoriteFoods with a value of an array of your favorite foods as strings ( hint: [] )
myInfo.favoriteFoods = ["Asado", "Empanadas", "sopa de mani"];

// Step 5: Add another property named hobbies with a value of an array of your hobbies as strings
myInfo.hobbies = ["Fishing", "Gym", "Calisthenic"];
...
myInfo.placesLived[0].place = "carapari, Bolivia";
myInfo.placesLived[0].length = "12 years";

// Step 9: Add additional objects with the same properties for each place you've lived
myInfo.placesLived.push({ place: "Tarija, Bolivia", length: "8 years" });
myInfo.placesLived.push({ place: "San Juan, Puerto Rico", length: "2 years" });
myInfo.placesLived.push({ place: "Cochabamba, Bolivia", length: "1 years" });
